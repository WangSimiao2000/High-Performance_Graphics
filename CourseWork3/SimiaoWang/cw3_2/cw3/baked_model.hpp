...
TriangleMesh prepareMeshes(const labutils::VulkanContext& aContext, const labutils::Allocator& aAllocator,
	std::vector<glm::vec3> vertexDate, std::vector<glm::vec2> texCoords, std::vector<glm::vec3> normals, std::vector<std::uint32_t> indices);
